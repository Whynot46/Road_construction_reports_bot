...
class Preparatory_steps(Construction_projects_steps):
    ...
    add_material_choice = State()  # Состояние для выбора: добавить материал или перейти дальше
...
class Earthworks_steps(Construction_projects_steps):
    ...
    add_work_choice = State()  # Состояние для выбора: добавить работу или перейти дальше
...
class Road_devices_steps(Construction_projects_steps):
    ...
    other_works = State()  # Напишите другую работу с объемом по обстановке дороги.
    add_work_choice = State()  # Состояние для выбора: добавить работу или перейти дальше
    photo_links = State()  # Ссылки на фото.
    is_ok = State()
